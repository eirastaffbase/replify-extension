...
const fillerStyle = { height: '24px', backgroundColor: '#007bff', textAlign: 'right', transition: 'width 0.4s ease-in-out', display: 'flex', alignItems: 'center', justifyContent: 'center' };
